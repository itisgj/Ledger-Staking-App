    ...
    completeDisplay = (
      ...
      <div style={{padding: 64, backgroundColor: "#eeffef", fontWeight: "bold", color: "rgba(0, 0, 0, 0.85)" }} >
        ...
        <div style={{ padding: 8 }}>
              <Button
                type={"ghost"}
                style={{ background: "#FBCEB1", borderColor: "yellow" }}
                onClick={() => {
                  console.log(exampleExternalContractBalance)
                  tx(writeContracts.ExampleExternalContract.donation("0x831235E44AD71dBD44A96ff4a8CF578373942FD0", exampleExternalContractBalance) )
                }}
              >
                💰 Donate
              </Button>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={"default"}
                style={{ background: "#22ee5b", borderColor: "yellow" }}
                onClick={() => {
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={"ghost"}
                style={{ background: "#dc143c", borderColor: "yellow" }}
                onClick={() => {
            ...
            <input id='stake_eth' type='number'/>

            <div style={{ padding: 8 }}>
              <Button
                type={balanceStaked ? "success" : "primary"}
                style={{ background: "#008080", borderColor: "yellow" }}
                onClick={() => {
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(`${document.getElementById('stake_eth').value}`) }));
                }}
              >
                🎰 Stake ether!
              </Button>
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={balanceStaked ? "success" : "primary"}
                style={{ background: "#bc544b", borderColor: "yellow" }}
                onClick={() => {
                  tx(writeContracts.Staker.resetTime());
                }}
              >
                ⏰ Reset!!
              </Button>
